...
- [ ] Execute the user-authorized code-only merge and deployment of PR #88 at the exact latest passing head: preserve deployed PR #87 behavior, rerun release validation as needed, merge into current `main`, checkpoint/auto-publish, synchronize GitHub, and verify public production routes and Class IV Collection mock copy. Do not import, activate, or mutate the 503-question production bank, metadata, learner attempts, accounts, purchases, invitations, or other production data.
