...
- [ ] Save and auto-publish the Class 1 complete-repair code artifact containing the reviewed display-order patch, release marker, guarded release utilities, documentation, and tracker updates; record the resulting deployment version before representing the code portion as live.
- [ ] Perform privacy-safe live-route verification for the published Class 1 practice experience, confirming repaired content and display-only option ordering without selecting an answer, creating a learner attempt, or exposing answer keys.
