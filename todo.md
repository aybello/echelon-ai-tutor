...
- [ ] Merge and deploy approved PR #82 as a code-only release: preserve its guarded Class IV activation command and do not run it; do not perform any live question-content activation, database repair command, learner-data write, migration, sign-in, or submission. Validate the merged head, publish a checkpoint, then verify public guidance and affected non-learner routes on managed and custom domains.
