...
- [ ] Complete final Class 1 Treatment production release verification: the exact 500-question package is promoted and database reconciliation confirms 805 Water Treatment / 815 Wastewater Treatment with zero imported-question attempts. Deploy the count-label frontend fix, then prove both custom and managed production domains show 805 / 815 on the unanswered Water and Wastewater practice routes before treating the release as complete.
- [ ] Deploy and verify the Class 1 Water Treatment and Wastewater Treatment learner-count label fix: subtitles and gated-access copy now use authoritative loaded metadata in development; publish the checkpoint and verify 805 / 815 on both production domains without selecting or submitting an answer.
