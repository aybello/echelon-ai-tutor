...
- [ ] Audit the current public pricing-to-checkout journey across supported products and devices, identify measurable conversion blockers, and implement only verified improvements with tests, accessible states, correct pricing, and explicit Stripe safety checks.
