...
- [ ] Merge and deploy approved PR #83 only after its latest head passes the reproduced cross-surface lazy-load recovery regression: preserve existing Process Guides, labelled diagrams, and learning flow; do not run any activation, migration, learner-data, question-content, sign-in, attempt, or submission action. Validate the exact merged head, publish a checkpoint, and verify the guide 3D model plus Equipment Lab recovery on managed and custom domains.
