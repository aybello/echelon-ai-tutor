...
- [ ] After publication, validate the new-student journey with the owner using a Stripe test or no-charge promotional checkout on the deployed Echelon domain; confirm successful payment/provisioning grants correct OIT access, then leave historical-entitlement replay, automated emails, and managed jobs disabled until separately approved.
