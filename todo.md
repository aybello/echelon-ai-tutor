...
- [ ] Publish and production-verify the GPT-6 Astra visual rebuild of the Equipment Lab circular clarifier: local reference-aligned redesign, full tests, TypeScript validation, production build, 2/2 public browser regression, and desktop/mobile reviews have passed. Before closure, save a validated checkpoint and confirm the updated workbench, Diagram fallback, Exploded canvas persistence, and reduced-motion behavior on both managed and custom production domains without authentication or learner activity.
