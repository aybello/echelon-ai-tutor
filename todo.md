...
- [ ] Complete the approved PR #90–#93 reliability release: restore PR #93’s exam-date commits to `main` because its original target was the billing branch, merge the resolved PR #90 access protections, rerun the combined checks, and publish only after all release gates are satisfied.
