...
export const BUNDLE_PRODUCTS: EchelonProduct[] = [
  ...
  },
  {
    ...
    name: "WPI Water Treatment Full Ladder Bundle",
    description: "Complete WPI Water Treatment ladder — Class I through Class IV. All 4 WPI Water exam question banks, unlimited attempts, AI Tutor, score history. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB). Save CA$157 vs buying individually.",
    priceCAD: 29900,
    examTypes: ["wpi-class1-water", "wpi-class2-water", "wpi-class3-water", "wpi-class4-water"],
  },
  {
    key: "bundle-wpi-wastewater",
    name: "WPI Wastewater Full Ladder Bundle",
    description: "Complete WPI Wastewater Treatment ladder — Class I through Class IV. All 4 WPI Wastewater exam question banks (1,503 questions total), unlimited attempts, AI Tutor, score history. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB). Save CA$157 vs buying individually.",
    priceCAD: 29900,
    examTypes: ["wpi-class1-wastewater", "wpi-class2-wastewater", "wpi-class3-wastewater", "wpi-class4-wastewater"],
  },
  {
    key: "bundle-all",
    name: "Complete All Access Bundle",
    description: "Every exam — all 19 Practice Passes in one bundle. Water Treatment (OIT–Class 4), Wastewater (Class 1–4), WQA, WPI Class I–IV Water & WPI Class I–IV Wastewater. Unlimited attempts, AI Tutor, score history. Save CA$1,402 vs buying individually.",
    priceCAD: 59900,
