...
export const BUNDLE_PRODUCTS: EchelonProduct[] = [
  ...
  },
  {
    ...
    description: "Complete WPI Water Treatment ladder — Class I through Class IV. All 4 WPI Water exam question banks, unlimited attempts, AI Tutor, score history. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB). Save CA$99 vs buying individually.",
    priceCAD: 29900,
  ...
  },
  {
    ...
    description: "Complete WPI Wastewater Treatment ladder — Class I through Class IV. All 4 WPI Wastewater exam question banks (1,503 questions total), unlimited attempts, AI Tutor, score history. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB). Save CA$120 vs buying individually.",
    priceCAD: 29900,
  ...
  },
  {
    ...
    description: "Every exam — all 22 Practice Passes in one bundle. Water Treatment (OIT–Class 4), Wastewater (Class 1–4), WQA, WPI Class I–IV Water & WPI Class I–IV Wastewater. Unlimited attempts, AI Tutor, score history. Save CA$1,265 vs buying individually.",
    priceCAD: 59900,
