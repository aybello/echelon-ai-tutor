...
import { hashWpiNewQuestionRows, hashWpiQuestionRows, planWpiClass4Release } from "../scripts/lib/wpiClass4Release.mjs";

function question(id, questionNum, reviewStatus = "unreviewed") {
  return {
