...
const lines=['# WPI Class IV Collection — authored repair preview','','All 503 historical identities have authored replacements. The completion flag records coverage, not proof of factual accuracy or exam equivalence. See docs/wpi-class4-collection-priority-review.md for the 25 priority dispositions.','',`Historical rows: 503. Authored replacements: ${review.patches.length}. Historical rows without an authored replacement: ${review.counts.editorial_review_remaining||0}. New additions authored: 0.`,'','The original database IDs, question numbers and answer positions are retained. A rewritten question changes what a historical answer means; prior attempts must not be reinterpreted as answers to the revised wording. No customer data or live database writes are used.',''];
