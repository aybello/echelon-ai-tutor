 ...
 *
 * ~35 states use the ABC/WPI standardized exam system.
 * California, Texas, Florida, and New York use their own state exams.
 */
...
export const US_STATE_CONFIGS: Record<USStateCode, USStateConfig> = {
  IA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Iowa DNR",
  ...
  CO: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "CDPHE",
  ...
  OR: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "OHA",
  ...
  ID: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Idaho DEQ",
  ...
  MT: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Montana DEQ",
  ...
  WY: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Wyoming DEQ",
  ...
  ND: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NDDEQ",
    examNote: "North Dakota uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "north-dakota",
  },
  SD: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "SD DANR",
    examNote: "South Dakota uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "south-dakota",
  },
  NE: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NDEE",
  ...
  KS: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "KDHE",
    examNote: "Kansas uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "kansas",
  },
  OK: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Oklahoma DEQ",
    examNote: "Oklahoma uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "oklahoma",
  },
  AR: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "ADH",
  ...
  MS: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "MSDH",
  ...
  AL: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "ADEM",
    examNote: "Alabama uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "alabama",
  },
  GA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Georgia EPD",
  ...
  SC: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "SCDHEC",
  ...
  NC: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NC DWR",
  ...
  VA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "VDH",
    examNote: "Virginia uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "virginia",
  },
  WV: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "WV BPH",
  ...
  MD: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "MDE",
  ...
  DE: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "DNREC",
  ...
  NJ: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NJDEP",
  ...
  CT: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "CT DPH",
  ...
  RI: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "RIDOH",
  ...
  MA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "MassDEP",
  ...
  VT: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "VT DEC",
  ...
  NH: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NHDES",
  ...
  ME: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Maine DWP",
  ...
  AK: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Alaska DEC",
  ...
  HI: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Hawaii DOH",
  ...
  NV: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NDEP",
  ...
  NM: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "NMED",
  ...
  UT: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Utah DDW",
  ...
  AZ: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "ADEQ",
  ...
  IN: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "IDEM",
  ...
  OH: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "Ohio EPA",
  ...
  MI: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "EGLE",
    examNote: "Michigan uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "michigan",
  },
  WI: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "WI DNR",
    examNote: "Wisconsin uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "wisconsin",
  },
  MN: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "MDH",
  ...
  MO: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "MO DNR",
  ...
  KY: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "KY DOW",
  ...
  TN: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "TDEC",
    examNote: "Tennessee uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "tennessee",
  },
  LA: {
    code: "LA", name: "Louisiana", certBody: "Louisiana Department of Health",
    certBodyUrl: "https://ldh.la.gov/page/operator-certification",
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "LDH",
  ...
  PA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "PA DEP",
  ...
  WA: {
    ...
    examFramework: "wpi", wpiSupported: true, certBodyAbbr: "WA DOH",
    examNote: "Washington uses the ABC/WPI standardized exam for water and wastewater operators.",
    slug: "washington",
  },
};

/** All US state codes that use WPI exams */
...
export const US_STREAMS = [
  { key: "water", label: "Water Treatment", icon: "💧" },
  { key: "ww", label: "Wastewater Treatment", icon: "🔄" },
  { key: "dist", label: "Water Distribution", icon: "🚰" },
  { key: "coll", label: "Wastewater Collection", icon: "🏗️" },
] as const;

/** The 4 class levels for US operators */
export const US_LEVELS = [
  { key: "class1", label: "Class I", description: "Entry-level operator certification" },
  { key: "class2", label: "Class II", description: "Intermediate operator certification" },
  { key: "class3", label: "Class III", description: "Advanced operator certification" },
  { key: "class4", label: "Class IV", description: "Chief/senior operator certification" },
] as const;

/** Get the WPI bank key for a US course */
export function getUSBankKey(level: string, stream: string): string {
  // US uses the same WPI question banks as Canadian WPI provinces
  return `wpi-${level}-${stream}`;
}

/** Get the US product key for a course */
export function getUSProductKey(level: string, stream: string): string {
  return `us-${level}-${stream}`;
}
