    ...
    waterLevels: [
      {
        ...
        label: "OIT Water",
        description: "Entry-level Ontario water operator certification. 400+ questions covering disinfection, hydraulics, regulations, and math.",
        available: true,
        stream: "water",
      },
      {
        ...
        label: "Class 1",
        description: "Class 1 Water Treatment — 400+ questions across coagulation, filtration, disinfection, and Ontario regulations.",
        available: true,
        stream: "water",
      },
      {
      ...
      },
      {
        ...
        label: "Class 3",
        description: "Class 3 Water Treatment — 400+ questions for senior operators.",
        available: true,
        stream: "water",
      },
      {
        ...
        label: "Class 4",
        description: "Class 4 Water Treatment — 400+ questions for chief operators.",
        available: true,
        stream: "water",
      },
    ],
    wastewaterLevels: [
      {
        ...
        description: "Entry-level Ontario wastewater operator certification. 400+ questions covering O. Reg. 129/04 and wastewater treatment fundamentals.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Class 1",
        description: "Class 1 Wastewater Treatment — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Class 2",
        description: "Class 2 Wastewater Treatment — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Class 3",
        description: "Class 3 Wastewater Treatment — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Class 4",
        description: "Class 4 Wastewater Treatment — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
    ],
  ...
  BC: {
    ...
    waterLevels: [
      ...
      },
      {
        ...
        label: "Level I",
        description: "EOCP Water Treatment Level I — 400+ questions covering treatment processes, equipment O&M, lab analysis, and source water.",
        available: true,
        stream: "water",
      },
      {
        ...
        label: "Level II",
        description: "EOCP Water Treatment Level II — 400+ questions for intermediate operators.",
        available: true,
        stream: "water",
      },
      {
        ...
        label: "Level III",
        description: "EOCP Water Treatment Level III — 400+ questions for senior operators.",
        available: true,
        stream: "water",
      },
      {
        ...
        label: "Level IV",
        description: "EOCP Water Treatment Level IV — 400+ questions for chief operators.",
        available: true,
        stream: "water",
      },
    ],
    wastewaterLevels: [
      {
        ...
        label: "Level I",
        description: "EOCP Wastewater Treatment Level I — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Level II",
        description: "EOCP Wastewater Treatment Level II — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Level III",
        description: "EOCP Wastewater Treatment Level III — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
      {
        ...
        label: "Level IV",
        description: "EOCP Wastewater Treatment Level IV — 400+ questions.",
        available: true,
        stream: "wastewater",
      },
    ],
