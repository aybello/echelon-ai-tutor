...
export const CLASS4_WW_QUESTIONS: C4WWQuestion[] = [
  ...
  },
  {
    ...
    tip: "Each Parshall flume throat width has its own K and n coefficients. For a 6-inch (0.15 m) flume in SI units: Q = 0.3812 × Ha^1.58.",
  },
  {
    id: 336,
    isCalc: true,
...
export const CLASS4_WW_FORMULA_LINKS: Record<string, string> = Object.fromEntries(
    ...
    return [`CL4-WW-${q.id}`, moduleToAnchor[q.module] || "#advanced-treatment",
  {
    ...
    topic: "Net Yield",
    question: `Y = 0.60, kd = 0.05/d, SRT = 15 d. Y_obs = Y/(1+kd×SRT)`,
    options: ["0.343", "0.60", "0.90", "0.1"],
    correct: 0,
    explanation: `Y_obs = 0.60/(1+0.75) = 0.343 g VSS/g BOD.`,
    isCalc: true,
    difficulty: "medium",
  },
  {
  ...
  },
  {
    ...
    options: ["21.4 mg O₂/g VSS/h", "0.36 mg O₂/g VSS/h", "2,800 mg O₂/g VSS/h", "0.021 mg O₂/g VSS/h"],
    correct: 0,
  ...
  },
  {
    ...
    question: `Influent TN = 50 mg/L, effluent TN = 7.18 mg/L, Q = 18,000 m³/d. What N mass is removed?`,
    options: ["771 kg N/d", "900 kg N/d", "129 kg N/d", "1,290 kg N/d"],
    correct: 0,
    explanation: `N removed = (50 - 7.18) × 18,000 / 1,000 = 771 kg N/d.`,
    isCalc: true,
    difficulty: "medium",
  },
  {
