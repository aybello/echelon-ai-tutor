...
export const wpiClass4WastewaterCollQuestions: WpiClass4WastewaterCollQuestion[] = [
  ...
  },
  {
    ...
    options: ["D/2", "D/4", "pi times D divided by 4", "D"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["Average dry-weather flow", "Infiltration/inflow rates", "Peak stormwater runoff", "Groundwater intrusion"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["0.6 m/s (2 fps) minimum at design flow", "0.3 m/s minimum", "3.0 m/s minimum", "1.5 m/s maximum"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["1.0 to 1.5", "6.0 to 10.0", "4.0 to 6.0", "1.5 to 4.0"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Normal depth", "Conjugate depth", "Sequent depth", "Critical depth"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["0.011", "0.030", "0.025", "0.013"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["108% of full-pipe flow (maximum occurs near 80-85% full)", "80%", "60%", "100%"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Increases along the pipe", "Equals the friction factor", "Decreases with pipe diameter", "Remains constant along a streamline (ignoring friction losses)"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Pressure only", "Pipe flow only", "Open-channel flow rate using a calibrated throat section and upstream depth measurement", "Velocity only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["0.3 m/s", "3.0 m/s", "1.5 m/s", "0.6 m/s (2 fps)"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Pump cavitation", "Motor overheating", "Seal failure", "Impeller wear"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["As the square of speed ratio", "Inversely proportional to speed ratio", "As the cube of speed ratio", "Directly proportional to speed ratio"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Higher efficiency", "Easier impeller access", "Higher flow capacity", "Lower installation cost and no separate pump room required"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Double the head", "Double the efficiency", "Approximately double the flow at the same head", "Half the flow"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Approximately double the head at the same flow", "Double the flow", "Double the efficiency", "Half the head"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Static head only", "Friction losses only", "Static head plus friction losses plus minor losses plus velocity head", "Velocity head only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Wire-to-water efficiency = hydraulic power output divided by electrical power input", "Only flow rate", "Only head", "Only motor efficiency"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Flow rates", "Pipe material", "Structural defects, root intrusion, joint offsets, and infiltration points", "Soil conditions"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Stormwater or surface water entering through manholes, roof drains, or direct connections", "Groundwater seeping through pipe cracks", "Sewage backing up from downstream", "Pump station inflow"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Chemical root treatment (foaming herbicides) combined with mechanical cutting", "Increasing flow velocity", "Pipe lining only", "Increasing pipe slope"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Pipe material", "Pipe slope", "Flow rates", "Illegal connections, defects, and I/I sources"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Reactive response only", "Only after SSOs", "Random scheduling", "Frequency based on pipe condition, history, and criticality"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Rehabilitation of deteriorated pipes without excavation, restoring structural integrity", "Only new pipe installation", "Only large-diameter pipes", "Only concrete pipes"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Excavating the old pipe", "Slip-lining the old pipe", "Lining the old pipe", "Fracturing the old pipe outward while simultaneously pulling in a new pipe of equal or larger diameter"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Increases pipe capacity", "Increases pipe diameter", "Has no effect on capacity", "Reduces pipe capacity but restores structural integrity and watertightness"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Entire pipe sections", "Only manhole defects", "Only root intrusion", "Localized defects (joint offsets, cracks, holes) without full pipe rehabilitation"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Pay higher sewer rates only", "Report annually only", "Install flow meters only", "Treat wastewater to meet local limits before discharge to the sewer"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["No limit", "1000 mg/L", "100-300 mg/L depending on jurisdiction", "10 mg/L"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Manhole rehabilitation, pipe lining, lateral lining, and illegal connection removal", "Only pipe replacement", "Only pump station upgrades", "Only flow monitoring"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only financial competency", "Only physical fitness", "That operators have demonstrated knowledge and skills to operate the system safely and in compliance", "Only equipment knowledge"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only municipal policy", "Only federal tax law", "OH&S regulations requiring permits, atmospheric testing, and rescue plans", "Only building codes"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Average dry-weather flow only", "Peak wet-weather flow only", "Average dry-weather flow plus I/I allowance with a peaking factor applied", "Maximum daily flow only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["A tee fitting only", "A straight tee perpendicular to flow", "A wye or saddle connection at 45 to 60 degrees from vertical to direct flow downstream", "A manhole connection only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["50 m", "500 m", "300 m", "120-150 m (400-500 ft)"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["PVC, HDPE, vitrified clay pipe (VCP), or lined concrete", "Concrete only", "Cast iron only", "Steel only"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Available within 30 minutes", "Available within 4 hours", "Available by phone only", "On standby at the entry point before entry begins"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Non-entry rescue retrieval of an incapacitated worker", "Lowering equipment only", "Measuring manhole depth", "Testing atmospheric conditions"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only one air change", "Ventilation to remove odour only", "Ventilation for 5 minutes only", "Continuous fresh air supply maintaining safe atmospheric conditions throughout entry"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Monthly only", "Before each use (bump test) and regularly calibrated per manufacturer specifications", "Annually only", "Never"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["H2S is below 1 ppm", "Only for supervisors", "Only in confined spaces", "Atmospheric hazards cannot be controlled by ventilation or exceed IDLH levels"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only water breaks", "Only shorter shifts", "Only PPE changes", "Scheduling work during cooler hours, hydration, rest breaks, buddy system, and heat illness recognition training"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["70 dBA", "100 dBA", "85 dBA (with hearing protection required above this level)", "60 dBA"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Thiobacillus bacteria oxidizing H2S to sulphuric acid on moist concrete surfaces", "Physical abrasion", "Chloride attack", "Freeze-thaw cycles"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Pipe roughness", "Pipe slope", "The organic pollution load in wastewater", "Flow velocity"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Assess pipe capacity", "Measure flow rate", "Quantify settleable and suspended solids for treatment plant loading and effluent compliance", "Assess pipe corrosion"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only pipe inspection", "Only flow monitoring", "Watertight pipes and manholes to prevent exfiltration of sewage into groundwater", "Only surface water protection"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Bioretention, permeable pavement, green roofs, and rain gardens to reduce runoff volume and peak flows", "Only grey infrastructure", "Only detention ponds", "Only underground storage"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only temperature increases", "Only freeze-thaw", "Only drought", "Increased precipitation intensity, sea level rise, and groundwater table changes affecting I/I and capacity"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Volume only", "Colour only", "Pathogen reduction and vector attraction reduction per regulatory standards (Class A, Class B)", "Odour only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Pipe material selection", "Annual budgets", "Staff scheduling", "Flow distribution and storage utilization during wet-weather events to reduce CSOs and SSOs"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Employee scheduling", "Permit applications only", "Financial accounting", "Asset mapping, condition tracking, work order management, and capacity analysis"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only pipe age", "Only financial performance", "SSO frequency, response time, customer complaints, and system reliability indicators", "Only staff metrics"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Assets with highest consequence of failure times probability of failure", "Oldest assets first", "Cheapest assets first", "Assets with most complaints"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Maximizing pump speed", "Reducing pipe diameter", "Increasing wet well size", "Optimizing pump scheduling, VFD use, and off-peak operation to reduce energy costs"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Maximize spending", "Meet only emergency needs", "Minimize spending", "Replace the system over its expected service life (e.g., 1-2% per year for 50-100 year life)"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only GIS data", "Only financial data", "Real-time sensor data, hydraulic models, and asset data for operational optimization and planning", "Only maintenance records"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["It is legally required only", "It reduces project cost only", "It builds community support, identifies concerns early, and improves project outcomes", "It is optional"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only flaring", "Only heating only", "Heat and power generation (CHP) to offset WWTP energy costs", "Only vehicle fuel only"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["1-2 years", "100 years", "5-10 years only", "20-50 years to accommodate long-term growth and infrastructure renewal"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only design of new sewers", "Only financial planning", "Capacity analysis, SSO prediction, I/I assessment, and planning of capital improvements", "Only regulatory reporting"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["SSOs per 100 km of sewer per year, normalized for system size and wet-weather events", "Number of SSOs only", "Cost of SSOs only", "Volume of SSOs only"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Oldest infrastructure first", "Cheapest projects first", "Risk, condition, regulatory requirements, and available funding", "Most visible projects first"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only capital funding", "Only user rates", "Full cost recovery including O&M, capital renewal, debt service, and reserves through user rates", "Only government grants"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only technical training", "Only safety training", "Operator certification, safety training, leadership development, and succession planning", "Only certification"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only internal notification", "Only media relations", "Only regulatory reporting", "Public notification, media relations, regulatory reporting, and post-event follow-up"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Pipe roughness", "Pipe slope", "Whether flow is laminar (Re < 2000) or turbulent (Re > 4000) in a pipe", "Pump efficiency"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Store excess peak flow and release it at a controlled rate to reduce downstream loading", "Maximize peak flow", "Minimize storage volume", "Increase average flow"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["C = R^(1/6) / n, where n is Manning roughness coefficient", "C = n only", "C = S only", "C = V only"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Weighing water", "Measuring flow colour", "Measuring pipe temperature", "Measuring the pressure differential across a calibrated orifice plate in a pipe"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Faraday's law of electromagnetic induction - voltage induced by conductive fluid moving through a magnetic field", "Doppler effect", "Pressure differential", "Ultrasonic transit time"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["In the morning (7-9 AM) and evening (5-8 PM) periods", "At midnight", "At noon only", "Uniformly throughout the day"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only pipe condition", "Only water quality", "Flow rates, depths, and velocities at key points to quantify I/I and system performance", "Only pipe pressure"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["m^3/day total only", "L/s per km of sewer or L/ha/day, normalized for comparison between systems", "L/s per km", "% of average flow"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Increased flow", "Reduced noise", "Leakage around the pump shaft, often visible as dripping or spray", "Increased efficiency"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Degraded motor winding insulation that could lead to motor failure", "Bearing wear", "Impeller wear", "Shaft misalignment"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Hydrogen sulphide (H2S) generated by anaerobic decomposition of sewage", "Pipe corrosion", "Pump oil leaks", "Electrical equipment"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["A set water level in the wet well to start or stop pumps", "A fixed flow rate", "A fixed time interval", "A fixed pressure"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Wet well level", "Motor temperature", "Pump speed", "Pumped flow rate for performance monitoring and billing"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only local alarms", "Only data logging", "Real-time monitoring, alarming, and control from a central location, reducing response time", "Only pump control"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["A confined space entry permit, atmospheric testing, ventilation, and a rescue plan", "Only a ladder", "Only ventilation", "Only a spotter"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Solids only", "BOD only", "Nutrients only", "H2S and other odorous compounds by adsorption onto activated carbon media"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Financial reporting standards", "Pipe material standards", "Equipment specifications", "Standardized inspection, assessment, and reporting protocols for sewer systems"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only high-pressure water", "Only vacuum", "High-pressure water jetting with vacuum extraction to clean and remove debris from sewers", "Only mechanical cleaning"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["New PVC pipes", "HDPE pipes", "Older clay or concrete pipes with deteriorated joints in areas with large trees", "Force mains"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Covers are new", "Covers are heavy", "Covers are painted", "Covers are cracked, corroded, or no longer fit properly, creating safety hazards or I/I entry points"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only CCTV from the main", "Only dye testing", "Only smoke testing", "Lateral launch cameras or push cameras inserted from the cleanout or main connection"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only a warning letter", "Only court action", "Notice of violation, compliance order, administrative penalty, or court action depending on severity", "Only permit revocation"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Routine maintenance", "Minor repairs", "Major capital projects that may have significant environmental impacts", "Equipment replacement"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Proper financial management, rate adequacy, and reserve fund maintenance", "Only technical compliance", "Only regulatory compliance", "Only capital planning"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only financial review", "Only financial audit", "Only permit review", "Review of O&M records, SSO logs, operator certifications, and system compliance"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only municipal standards", "Only US standards", "CSA, AWWA, WEF, and provincial guidelines for pipe materials, design flows, and construction", "Only manufacturer specifications"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only pipe sizing", "Only manhole locations", "Pipe sizing, manhole locations, service connections, grades, and coordination with other utilities", "Only service connections"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Minimum cover only", "Only gravity flow", "Careful grade design to maintain minimum self-cleansing velocity, possibly with pump stations", "Only force mains"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Standard bedding only", "Only concrete anchors", "Only watertight joints", "Buoyancy calculations, concrete anchors or ballast, and watertight joints to prevent flotation"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Flexible joints, ductile pipe materials, and separation from other utilities to accommodate ground movement", "Standard pipe joints", "Only ductile pipe", "Only flexible joints"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only atmospheric testing", "Only permit completion", "Only PPE check", "Permit completion, atmospheric testing, ventilation setup, rescue plan, communication, and PPE verification"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Immediate evacuation and investigation of the source before re-entry", "No action", "Only ventilation increase", "Only PPE upgrade"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["No PPE", "Only eye protection", "Only gloves", "Gloves, eye protection, and appropriate respiratory protection; SDS review before use"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["It has no effect on safety", "It only affects quality", "It only affects productivity", "It impairs judgment, reaction time, and physical performance, increasing accident risk"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only annually", "Only when required by regulation", "Only after incidents", "Regularly (daily or weekly) to identify and correct hazards before incidents occur"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Provincial OH&S legislation, which protects workers from reprisal for refusing unsafe work", "No legislation", "Only union agreements", "Only company policy"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only a signed contract", "Only supervision", "Pre-qualification, site orientation, safety plan review, and supervision of contractor activities", "Only orientation"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only incident reports", "Only inspection records", "Only training records", "Incident reports, near-miss reports, inspection records, training records, and safety meeting minutes"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only current conditions", "Only sea level rise", "Only temperature changes", "Increased precipitation intensity, flooding risk, sea level rise, and temperature effects on system performance"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only regulatory compliance", "Only pollution prevention", "Proactive environmental protection beyond minimum requirements, including habitat restoration and pollution prevention", "Only habitat restoration"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only to regulators", "Only to ratepayers", "System environmental performance to regulators, ratepayers, and the public for accountability", "Only to the public"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only sewer history", "Only pump station operation", "Only pipe materials", "Proper disposal of household chemicals, pharmaceuticals, and FOG to protect the sewer system and environment"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["A utility fails to meet regulatory requirements, requiring corrective action within a specified timeframe", "Routine maintenance is due", "Financial reports are late", "Staff turnover occurs"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only property damage", "Only worker injuries", "Third-party claims for environmental damage caused by SSOs, spills, or other operational incidents", "Only equipment damage"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Annually by senior management to assess EMS performance and set improvement objectives", "Only when problems occur", "Only for regulatory audits", "Only for financial audits"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only supervisor training", "Only operator training", "All staff understand their environmental responsibilities and the procedures to prevent environmental incidents", "Only management training"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only cost sharing", "Only knowledge exchange", "Shared services, joint procurement, knowledge exchange, and coordinated infrastructure planning", "Only joint procurement"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only capital projects", "Only O&M activities", "O&M activities, capital investments, and organizational development with long-term community goals", "Only financial planning"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Research collaboration, student placements, and access to emerging technologies and expertise", "Only financial support", "Only student placements", "Only research only"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only external audits", "Only performance measurement", "Only corrective actions", "Plan-Do-Check-Act (PDCA) cycle with performance measurement, root cause analysis, and corrective actions"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["All risk to the public", "Equal risk to both parties", "All risk to the private sector", "Risks to the party best able to manage them (design/build/operate risks to private, regulatory/political risks to public)"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only current technology use", "Only software upgrades", "Only equipment replacement", "Future technology adoption (smart sensors, AI, digital twins) aligned with organizational capacity and budget"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only regulatory compliance", "Only financial management", "Systematic approach to environmental management with continual improvement commitment", "Only technical competence"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Systematic approach to OH&S management with worker participation and continual improvement", "Only safety training", "Only regulatory compliance", "Only equipment safety"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only asset inventory", "Only financial management", "Systematic approach to asset management aligned with organizational objectives and stakeholder needs", "Only technical management"],
    correctAnswer: 2,
...

  {
    ...
    options: ["Metered inflows to the WWTP against the sum of tributary sub-catchment flows to identify measurement errors", "Only inflow to the system", "Only outflow from the system", "Only pump station flows"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Pipes are old", "Pipes are small", "Hydraulic grade line rises above the pipe crown under design flow conditions, causing surcharge or overflow", "Flow velocity is low"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["1-year storm", "25-year storm", "100-year storm", "5-year or 10-year storm for sanitary sewers, depending on regulatory requirements"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Uniform velocity", "Maximum velocity at the pipe wall", "Maximum velocity near the pipe centerline and zero velocity at the pipe wall (no-slip condition)", "Minimum velocity at the centerline"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Proper meter selection, installation, calibration, and maintenance", "Using older meters", "Using cheaper meters", "Using fewer meters"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Slow valve operation", "Gradual flow changes", "Rapid pump start/stop or valve closure creating pressure waves that can damage pipes and fittings", "Low flow velocity"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Visual inspection only", "Only data completeness", "Comparing measured flows against expected values, checking for sensor drift, and validating data completeness", "Only sensor calibration"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Bearing wear particles, contamination, and oil degradation indicating maintenance needs", "Only oil level", "Only oil colour", "Only oil temperature"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only pipe leaks", "Only motor temperature", "Hot spots in electrical panels, motor windings, and bearings indicating potential failures", "Only electrical faults"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only improve appearance", "Only improve flow", "Only reduce odour", "Remove accumulated grit, grease, and debris that reduce active storage and can damage pumps"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Accurate wet well level measurement for proper pump control and alarm activation", "Only accurate billing", "Only alarm accuracy", "Only pump control"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only water pressure", "Only blockage type", "Only pipe diameter", "Pipe diameter, blockage type (grease, roots, grit), and cleaning objective"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Pipe diameter only", "Only root intrusion", "I/I from defective service laterals, which can represent 50% or more of total system I/I", "Only structural defects"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Infiltration at pipe joints using chemical grout injected through the pipe wall", "Pipe cracks", "Only structural defects", "Only root intrusion"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only large pipes", "Only small pipes", "CCTV inspection of pipes from 100 mm to 1500 mm diameter with remote-controlled camera systems", "Only manual inspection"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Pipe cross-section geometry to detect deformation, ovality, and structural defects", "Pipe material", "Pipe age", "Pipe slope"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Pipe material only", "Only pipe depth", "Only pipe location", "Voids, soil settlement, and pipe condition from the surface without excavation"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only the volume of overflow", "Only the location", "Only the cause", "Severity, duration, environmental impact, and compliance history of the violation"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Permanent non-compliance", "Only technical relief", "Only financial relief", "Temporary relief from a specific regulatory requirement while a utility implements corrective measures"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only fee payment", "Only technical report", "Only application form", "Updated system information, performance data, and compliance history review by the regulatory authority"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Routine maintenance is due", "Financial reports are late", "Immediate environmental harm is occurring or imminent, requiring immediate corrective action", "Staff turnover occurs"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Proactive communication, transparency, and collaborative problem-solving with the regulatory authority", "Only compliance", "Only legal action", "Only financial contributions"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Monitoring regulatory changes, assessing impacts, updating procedures, and training staff", "Only monitoring regulations", "Only updating procedures", "Only training staff"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only storage", "Only screening", "Screening, storage, treatment, and disinfection to reduce CSO impacts on receiving waters", "Only treatment"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only open cut", "Only pipe jacking", "Trenchless pipe installation using a remotely controlled boring machine for pipes 300-3000 mm diameter", "Only directional drilling"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only open cut", "Only microtunneling", "Only pipe jacking", "Trenchless installation of pipes under obstacles (rivers, roads, railways) using a steerable drill"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only gravity flow", "Only conventional gravity sewers", "Only pressure sewers", "Differential air pressure to transport sewage in small-diameter pipes, suitable for flat or difficult terrain"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Natural treatment processes (vegetation, soil, microorganisms) to treat CSO flows before discharge", "Only conventional treatment", "Only chemical treatment", "Only physical treatment"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Only incident reports", "Only inspections", "Job hazard analysis (JHA) before each task to identify hazards and control measures", "Only regulations"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only the immediate cause", "Only the worker error", "Underlying systemic causes (management systems, procedures, training) that allowed the incident to occur", "Only equipment failure"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only financial performance", "Only regulatory compliance", "Outstanding environmental performance, innovation, and community engagement by utilities", "Only safety performance"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Only software upgrades", "Only staff training", "Only hardware upgrades", "Smart sensors, IoT connectivity, data analytics, and AI to improve operational efficiency and decision-making"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["Only water", "Only nutrients", "Only energy", "Water, energy, nutrients, and materials from wastewater as valuable resources rather than waste"],
    correctAnswer: 3,
