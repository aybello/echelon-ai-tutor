...
const CeuInstructorReview = lazy(() => import("./pages/CeuInstructorReview"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path={"/equipment-lab"} component={EquipmentLab} />
        ...
        <Route path={"/continuing-education-review"} component={CeuInstructorReview} />
