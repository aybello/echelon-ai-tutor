...
export default function Class2WastewaterCollQuiz() {
  ...
  const session = useQuizSession({ examType: "class2-wastewater-coll", allQuestions });
  ...
  return (
    <QuizShell
      ...
      headerIcon="🔩"
      headerActions={[
        { label: "📝 Mock Exam →", href: "/class2-wastewater-coll-mock" },
        { label: "🃏 Flashcards", href: "/class2-wastewater-coll-flashcards" },
      ]}
      ...
      mockExamHref="/class2-wastewater-coll-mock"
