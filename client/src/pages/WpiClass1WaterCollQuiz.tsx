...
export default function WpiClass1WaterCollQuiz() {
  ...
  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, isLoading: bankLoading, dbUnavailable } = useQuestionBank("wpi-class1-wastewater-coll", "lazy");
