...
export default function WpiClass2WaterQuiz() {
  ...
  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, isLoading: bankLoading } = useQuestionBank("wpi-class2-water");
  ...
  const logAttemptFn = useAttemptLogger("wpi-class2-water", quizMode);
  ...
  const { data: missedData, refetch: refetchMissed } = trpc.quiz.getMissedQuestions.useQuery(
    { examType: "wpi-class2-water", limit: 50 },
