// CLASS 2 WATER TREATMENT MOCK EXAM
...
function selectExamQuestions(): Class2WaterQuestion[] {
  const pool = [...CLASS2_WATER_QUESTIONS].sort(() => Math.random() - 0.5);
  const selected: Class2WaterQuestion[] = [];
...
const SESSION_ID = (() => {
  const key = "echelon_class2water_mock_session";
...
export default function Class2WaterMockExam() {
  usePageMeta({
    title: "Class 2 Water Treatment Timed Mock Exam",
    description: "100-question timed mock exam for the Ontario Class 2 Water Treatment operator certification. 2-hour timer, 70% pass threshold, and full module breakdown on results.",
    path: "/class2-water-mock",
    keywords: "Class 2 water treatment mock exam, Ontario operator exam, OWWCO Class 2, O. Reg. 128/04 practice test",
  });

  const [examState, setExamState]   = useState<ExamState>("intro");
  const [questions, setQuestions]   = useState<Class2WaterQuestion[]>([]);
        ...
        <div style={{ minHeight: "100vh", background: "#F1F5F9", fontFamily: "'Sora', sans-serif" }}>
          ...
          <div style={{ maxWidth: 600, margin: "0 auto", padding: "48px 20px" }}>
            <div style={{ background: "#fff", borderRadius: 20, padding: "40px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", textAlign: "center" }}>
              ...
              <h1 style={{ fontSize: 26, fontWeight: 800, color: "#0F172A", marginBottom: 8 }}>Class 2 Water Treatment Mock Exam</h1>
              <p style={{ fontSize: 14, color: "#64748B", marginBottom: 20, lineHeight: 1.6 }}>
                Simulates the Ontario Class 2 Water Treatment certification exam. Covers all 5 exam modules proportionally.
              </p>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 28 }}>
                {[
                  ...
                  { icon: "📊", label: "Modules",    value: "5 Topics" },
              ...
              <div style={{ marginTop: 16 }}>
                <Link href="/class2-water" style={{ fontSize: 12, color: "#94A3B8", textDecoration: "none" }}>
                  &laquo; Back to Class 2 Water Practice
                </Link>
              </div>
            </div>
          </div>
      ...
      <div style={{ minHeight: "100vh", background: "#F1F5F9", fontFamily: "'Sora', sans-serif" }}>
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", padding: "32px 20px 80px" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <Link href="/class2-water" style={{ flex: 1, minWidth: 140 }}>
