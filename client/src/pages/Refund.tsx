    ...
    <div style={{ fontFamily: "'Sora', sans-serif", background: "#F1F5F9", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 120px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 14, color: "#94A3B8", margin: 0 }}>Last updated: September 3, 2026</p>
        </div>
        ...
        <div style={{ background: "linear-gradient(135deg, #EFF6FF, #F0FDF4)", border: "1px solid #BFDBFE", borderRadius: 14, padding: "24px 28px", marginBottom: 32 }}>
          ...
          <ul style={{ fontSize: 14, color: "#334155", lineHeight: 1.8, margin: 0, paddingLeft: 20 }}>
            <li><strong>One-time passes:</strong> {REFUND_WINDOW_DAYS}-day refund window and fewer than {INDIVIDUAL_REFUND_QUESTION_LIMIT} completed questions.</li>
            <li><strong>Subscriptions:</strong> Cancel anytime; access continues until end of billing period. No prorated refunds.</li>
            <li><strong>Teams plans:</strong> Contact us within {REFUND_WINDOW_DAYS} days of purchase if no operator seat or Course Pass has been assigned or activated.</li>
            <li><strong>How to request:</strong> Email <a href={`mailto:${REFUND_CONTACT_EMAIL}`} style={{ color: "#3B82F6" }}>{REFUND_CONTACT_EMAIL}</a> with your purchase email and Stripe receipt.</li>
          </ul>
        </div>
        ...
        <LegalSection title="One-Time Practice Passes">
          ...
          <ul>
            <li>The refund request is made within <strong>{REFUND_WINDOW_DAYS} days</strong> of the original purchase date.</li>
            <li>You have completed <strong>fewer than {INDIVIDUAL_REFUND_QUESTION_LIMIT} questions</strong> on the pass.</li>
          </ul>
        ...
        <LegalSection title="Teams Plans">
          <p>Teams plan purchases are eligible for a full refund within {REFUND_WINDOW_DAYS} days of purchase if no operator seat or Course Pass has been assigned or activated. Once any operator has been assigned or activated, the purchase is non-refundable.</p>
        ...
        <LegalSection title="Non-Refundable Situations">
          <ul>
            ...
            <li>Passes where {INDIVIDUAL_REFUND_QUESTION_LIMIT} or more questions have been completed.</li>
        ...
        <LegalSection title="How to Request a Refund">
          <p>Email <a href={`mailto:${REFUND_CONTACT_EMAIL}?subject=Refund%20Request`} style={{ color: "#3B82F6" }}>{REFUND_CONTACT_EMAIL}</a> with:</p>
          <ul>
        ...
        <div style={{ marginTop: 48, padding: "20px 24px", background: "#fff", borderRadius: 12, border: "1px solid #E2E8F0", textAlign: "center" }}>
          ...
          <a href={`mailto:${REFUND_CONTACT_EMAIL}?subject=Refund%20Question`} style={{ color: "#3B82F6", fontWeight: 700, fontSize: 13 }}>Email {REFUND_CONTACT_EMAIL} →</a>
        </div>
      </div>
    </div>
  );
