// Class 4 Wastewater Practice Quiz — Unified via useQuizSession hook
...
export default function Class4WastewaterQuiz() {
  ...
  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, formulaLinks, isLoading: bankLoading, dbUnavailable } = useQuestionBank("class4-wastewater", "lazy");
  ...
  const session = useQuizSession({ examType: "class4-ww", allQuestions });
  ...
  return (
    <QuizShell
      ...
      courseSubtitle="500 questions · Ontario Class 4 Wastewater Treatment"
