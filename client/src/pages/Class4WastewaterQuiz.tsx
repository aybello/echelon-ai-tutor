...
export default function Class4WastewaterQuiz() {
  ...
  const [current, setCurrent]       = useState<C4WWQuestion | null>(() => {
  ...
  // ── Get next question ─────────────────────────────────────────────────────
  const getNext = useCallback((currentPool: C4WWQuestion[]): C4WWQuestion | null => {
  ...
  return (
    <PurchaseGate
      examType="class4-ww"
      productKey="class4-ww"
      productName="Ontario Class 4 · Wastewater Treatment"
      price={499}
    >
      <QuizShell
        ...
        courseSubtitle="Ontario OWWCO Class 4 Wastewater Exam Prep"
