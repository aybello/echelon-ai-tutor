// WPI CLASS I WASTEWATER TREATMENT PRACTICE QUIZ
...
// Adapt WpiClass1WastewaterQuestion to the shape expected by sub-components
type QCompat = WpiClass1WastewaterQuestion & { q: string; wrongExp?: Record<number, string> };
...
export default function WpiClass1WastewaterQuiz() {
  usePageMeta({
    ...
    description:
      "Practice for the WPI Class I Wastewater Treatment operator exam (BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan, Manitoba) with 502 questions across 5 modules. AI Tutor, step-by-step solutions, and confidence tracking included.",
  ...
  const [current, setCurrent] = useState<QCompat | null>(
    () => toCompat(wpiClass1WastewaterQuestions[0])
  );
  ...
  const moduleStats = useMemo(() => {
    ...
    for (const m of WPI_CLASS1_WASTEWATER_MODULES) stats[m] = { correct: 0, total: 0 };
  ...
  return (
    ...
    >
      <SiteNav currentPath="/wpi-class1-wastewater" />
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "32px 16px 80px" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            {WPI_CLASS1_WASTEWATER_MODULES.map((m) => {
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <button
                onClick={() => {
                  setHistory([]);
                  setCurrent(toCompat(wpiClass1WastewaterQuestions[0]));
                  setSelected(null);
                  setConfidence(null);
                  setConfirmed(false);
                  setShowSteps(false);
              ...
              <Link href="/wpi-class1-wastewater-mock">
                <button
                  style={{
                    padding: "12px 28px",
                    borderRadius: 10,
