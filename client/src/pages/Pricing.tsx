...
const INDIVIDUAL: Product[] = [
  ...
  },
  {
    ...
    description: "WPI Class I Water Distribution — 150 questions covering distribution system basics, pipe materials, pressure & flow, chlorine residual maintenance, valve & hydrant operation, and regulations. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 9900,
    ...
    border: "#BAE6FD",
    available: true,
    features: ["150 distribution questions", "Timed mock exam", "AI Tutor", "Score history", "BC / AB / SK / MB", "400+ flashcards"],
  },
  {
    key: "wpi-class2-water-dist",
    name: "WPI Class II Water Distribution Practice Pass",
    shortName: "WPI Class II Distribution",
    description: "WPI Class II Water Distribution — 136 questions covering hydraulic analysis, pressure zone design, water quality management, cross-connection control, and regulatory compliance. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 14900,
    ...
    border: "#99F6E4",
    available: true,
    features: ["136 distribution questions", "Timed mock exam", "AI Tutor", "Score history", "BC / AB / SK / MB", "400+ flashcards"],
  },
  {
    key: "wpi-class3-water-dist",
    name: "WPI Class III Water Distribution Practice Pass",
    shortName: "WPI Class III Distribution",
    description: "WPI Class III Water Distribution — 150 questions covering advanced hydraulic modeling, transmission main design, multi-zone systems, SCADA & automation, and senior operator responsibilities. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 24900,
  ...
  },
  {
    ...
    description: "WPI Class IV Water Distribution — 150 questions covering large-scale system management, asset management, advanced water quality, DWQMS implementation, and strategic regulatory compliance. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 29900,
  ...
  },
  {
    ...
    description: "WPI Class I Wastewater Collection — 150 questions covering collection system components, lift station operation, confined space safety, basic hydraulics, and environmental regulations. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 9900,
    ...
    border: "#A7F3D0",
    available: true,
    features: ["150 collection questions", "Timed mock exam", "AI Tutor", "Score history", "BC / AB / SK / MB", "400+ flashcards"],
  },
  {
    key: "wpi-class2-water-coll",
    name: "WPI Class II Wastewater Collection Practice Pass",
    shortName: "WPI Class II Collection",
    description: "WPI Class II Wastewater Collection — 150 questions covering advanced collection system design, intermediate lift station operations, system maintenance & rehabilitation, hydraulics & flow analysis, and regulatory compliance. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 14900,
  ...
  },
  {
    ...
    description: "WPI Class III Wastewater Collection — 150 questions covering complex system operations & SCADA, advanced pump station engineering, system hydraulic modelling, advanced maintenance management, and leadership & regulatory management. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 24900,
  ...
  },
  {
    ...
    description: "WPI Class IV Wastewater Collection — 150 questions covering system planning & capital improvement, advanced engineering & design, utility management & leadership, advanced regulatory & environmental management, and emerging technologies. Recognized by EOCP (BC), AWWOA (AB), SAHO (SK), and MWWA (MB).",
    priceCAD: 29900,
