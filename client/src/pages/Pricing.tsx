...
const INDIVIDUAL: Product[] = [
  ...
  },
  {
    ...
    description: "Ontario Class 1 Water Distribution — 500 questions. Covers pipe materials, valve operation, hydrant maintenance, and pressure management. Aligned with OWWCO Class 1 certification.",
    ...
    border: "#BAE6FD",
    available: true,
    features: ["500 practice questions", "Timed mock exam", "AI Tutor", "Score history", "400+ flashcards", "Ontario OWWCO"],
  },
  {
    key: "class2-water-dist",
    name: "Class 2 Water Distribution Practice Pass",
    shortName: "Class 2 Distribution",
    description: "Ontario Class 2 Water Distribution — 500 questions. Covers system design, water main installation, cross-connection control, and distribution operations. Aligned with OWWCO Class 2 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 3 Water Distribution — 500 questions. Covers advanced hydraulics, system modelling, asset management, and distribution system planning. Aligned with OWWCO Class 3 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 4 Water Distribution — 500 questions. Covers strategic asset management, risk-based frameworks, KPIs, capital planning, and regulatory compliance. Aligned with OWWCO Class 4 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 1 Wastewater Collection — 500 questions. Covers collection system basics, I/I identification, manhole inspection, and O. Reg. 129/04. Aligned with OWWCO Class 1 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 2 Wastewater Collection — 500 questions. Covers collection system design, sewer rehabilitation, pump station operations, and CSO management. Aligned with OWWCO Class 2 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 3 Wastewater Collection — 500 questions. Covers advanced collection system hydraulics, CCTV inspection, force main design, and Long-Term Control Plans. Aligned with OWWCO Class 3 certification.",
  ...
  },
  {
    ...
    description: "Ontario Class 4 Wastewater Collection — 500 questions. Covers strategic collection system management, lifecycle cost optimization, green infrastructure, and regulatory compliance. Aligned with OWWCO Class 4 certification.",
