// WPI CLASS IV WATER TREATMENT PRACTICE QUIZ
...
// Adapt WpiClass4WaterQuestion to the shape expected by sub-components
type QCompat = WpiClass4WaterQuestion & { q: string; wrongExp?: Record<number, string> };
...
export default function WpiClass4WaterQuiz() {
  usePageMeta({
    ...
    description:
      "Practice for the WPI Class IV Water Treatment operator exam (BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan, Manitoba) with 502 questions across 5 modules. AI Tutor, step-by-step solutions, and confidence tracking included.",
    path: "/wpi-class4-water",
    keywords:
      "WPI Class IV water treatment exam prep, BC EOCP Level III, Alberta AWWOA Class IV, Saskatchewan water operator, Manitoba water operator, WPI practice questions",
  });
  ...
  const [current, setCurrent] = useState<QCompat | null>(
    () => toCompat(wpiClass4WaterQuestions[0])
  );
  ...
  const moduleStats = useMemo(() => {
    ...
    for (const m of WPI_CLASS4_WATER_MODULES) stats[m] = { correct: 0, total: 0 };
  ...
  return (
    ...
    >
      <SiteNav currentPath="/wpi-class4-water" />
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <button
                onClick={() => {
                  setHistory([]);
                  setCurrent(toCompat(wpiClass4WaterQuestions[0]));
                  setSelected(null);
                  setConfidence(null);
                  setConfirmed(false);
                  setShowSteps(false);
              ...
              <Link href="/wpi-class4-water-mock">
                <button
                  style={{
                    padding: "12px 28px",
                    borderRadius: 10,
