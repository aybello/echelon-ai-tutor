// WPI Class 4 Water Practice Quiz — Unified via useQuizSession hook
...
const MODULE_COLORS: Record<string, { bg: string; color: string }> = {
  ...
  "Expert System Design & Optimization": { bg: "#DCFCE7", color: "#15803D" },
  "Advanced QA/QC & Research": { bg: "#EDE9FE", color: "#6D28D9" },
  "Watershed & Source Protection": { bg: "#CCFBF1", color: "#0F766E" },
  "Executive Management & Compliance": { bg: "#FFEDD5", color: "#C2410C" },
};
const MODULE_ICONS: Record<string, string> = {
  "Expert Treatment Operations": "⚗️",
  "Expert System Design & Optimization": "🔧",
  "Advanced QA/QC & Research": "🔬",
...
export default function WpiClass4WaterQuiz() {
  usePageMeta({
    title: "WPI Class 4 Water Treatment Practice Quiz",
    description: "Practice for the WPI Class 4 Water Treatment operator exam with 500 questions.",
    path: "/wpi-class4-water",
    keywords: "WPI Class 4 water treatment, operator exam prep",
  });

  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, formulaLinks, isLoading: bankLoading, dbUnavailable } = useQuestionBank("wpi-class4-water", "lazy");
  ...
  const session = useQuizSession({ examType: "wpi-class4-water", allQuestions });
  ...
  return (
    <QuizShell
      ...
      headerIcon="👑"
      headerActions={[
        { label: "📝 Mock Exam →", href: "/wpi-class4-water-mock" },
        { label: "🃏 Flashcards", href: "/wpi-class4-water-flashcards" },
      ]}
      ...
      gate={session.trialDone && !session.trialUnlocked ? (
        <QuizGate
          ...
          productName="WPI Class 4 Water Treatment Practice Pass"
          priceLabel="CA$299"
          paidFeatures={[
            "502 WPI Class 4 questions — unlimited attempts",
