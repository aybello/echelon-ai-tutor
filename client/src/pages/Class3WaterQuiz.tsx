// Class 3 Water Practice Quiz — Unified via useQuizSession hook
...
const MODULE_CONFIG: ModuleConfig[] = [
  { name: "Advanced Treatment Processes", icon: "🧪", bg: "#DBEAFE", color: "#1D4ED8" },
  { name: "Advanced Disinfection", icon: "☣️", bg: "#EDE9FE", color: "#6D28D9" },
  { name: "Water Quality Management", icon: "🔬", bg: "#CCFBF1", color: "#0F766E" },
  { name: "Distribution System Management", icon: "🚰", bg: "#E0F2FE", color: "#0284C7" },
  { name: "Regulatory Compliance", icon: "📋", bg: "#FFEDD5", color: "#C2410C" },
  { name: "Advanced Math & Calculations", icon: "📐", bg: "#FEE2E2", color: "#B91C1C" },
  { name: "Plant Operations & Management", icon: "🏭", bg: "#FEF9C3", color: "#A16207" },
];

export default function Class3WaterQuiz() {
  usePageMeta({
    title: "Class 3 Water Treatment Practice Questions",
    description: "Practice Questions for Ontario OWWCO Class 3 Water Treatment operator certification exam. AI-powered exam prep with detailed explanations.",
  });

  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, isLoading: bankLoading, dbUnavailable } = useQuestionBank("class3-water", "lazy");
  ...
  return (
    <QuizShell
      ...
      courseSubtitle="500 questions · Ontario Class 3 Water Treatment"
