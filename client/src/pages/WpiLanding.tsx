...
const FAQS = [
  ...
  },
  {
    ...
    a: "Each Individual Exam Pass includes 400+ adaptive practice questions, a timed mock exam, a formula sheet, AI Tutor access, 400+ flashcards, and module study notes with permanent access.",
  },
  {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: "16px 16px 0", flex: 1 }}>
                    ...
                    <div style={{ fontSize: 11, color: "#64748B", marginBottom: 12 }}>One-time payment · permanent access</div>
