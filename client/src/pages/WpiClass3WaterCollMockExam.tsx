...
export default function WpiClass3WaterCollMockExam() {
  usePageMeta({
    title: "WPI Class 3 Water Collection Mock Exam",
  ...
  return (
    <MockExamShell
      ...
      metaDescription="100-question timed mock exam for the WPI Class III Wastewater Collection certification. 3-hour timer, 70% pass threshold."
