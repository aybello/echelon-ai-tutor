...
export default function WpiClass3WaterDistMockExam() {
  usePageMeta({
    title: "WPI Class 3 Water Distribution Mock Exam",
  ...
  return (
    <MockExamShell
      ...
      metaDescription="100-question timed mock exam for the WPI Class III Water Distribution certification. 3-hour timer, 70% pass threshold."
