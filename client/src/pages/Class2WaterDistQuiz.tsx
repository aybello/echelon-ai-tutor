...
export default function Class2WaterDistQuiz() {
  usePageMeta({
    ...
    description: "Practice questions for the Ontario Class 2 Water Distribution operator certification exam. 300 questions aligned to Ontario O. Reg. 170/03 and O. Reg. 129/04.",
  });
  ...
  return (
    <QuizShell
      ...
      courseSubtitle="300 questions · Ontario Class 2 Water Treatment (Distribution)"
