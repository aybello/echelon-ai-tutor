...
export default function Admin() {
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Sora', sans-serif" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ color: "#F8FAFC", fontSize: 18, fontWeight: 700, marginBottom: 8 }}>Sign in required</div>
  ...
  if (user.role !== "admin") {
    return (
      <div style={{ minHeight: "100vh", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Sora', sans-serif" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>⛔</div>
          <div style={{ color: "#F8FAFC", fontSize: 18, fontWeight: 700, marginBottom: 8 }}>Admin access only</div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FFFFFF", fontFamily: "'Sora', sans-serif", color: "#1E293B" }}>
      ...
      {/* Top bar */}
      <div className="admin-top-bar" style={{ background: "#FFFFFF", borderBottom: "1px solid rgba(0,0,0,0.07)", padding: "14px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <Link href="/"><button className="admin-btn" style={{ padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#64748B", fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}>← Site</button></Link>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 20px 80px" }}>
        ...
        <div className="admin-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
          ...
          <button
            ...
            style={{ padding: "8px 16px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#64748B", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}
          >
            ↻ Refresh
          </button>
        </div>
        ...
        <div className="admin-stats" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, marginBottom: 28 }}>
          {statItems.map(s => (
            <button
              ...
              style={{
                background: activeTab === s.tab ? "#EFF6FF" : "#FFFFFF",
        ...
        {/* Tab bar */}
        <div className="admin-tab-bar" style={{ display: "flex", gap: 4, marginBottom: 16, background: "#FFFFFF", borderRadius: 12, padding: 4 }}>
          {TABS.map(tab => (
            <button
              key={tab.id}
        ...
        {activeTab === "trials" && (
          <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(0,0,0,0.07)" }}>
              ...
              {trialsQ.data && trialsQ.data.length > 0 && (
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button
                    ...
                    style={{ padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#38BDF8", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}
                  >
                  ...
                  <button
                    ...
                    style={{ padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#A78BFA", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}
                  >
                    ⬇ Download CSV
                  </button>
                </div>
            ...
            {trialsQ.data && trialsQ.data.length === 0 && (
              <div style={{ padding: 40, textAlign: "center", color: "#64748B", fontSize: 13 }}>No trial signups yet.</div>
            )}
            {trialsQ.data && trialsQ.data.length > 0 && (
                ...
                <tbody>
                  {trialsQ.data.map((row, i) => (
                    <tr key={row.id} className="admin-row" style={{ borderTop: "1px solid rgba(0,0,0,0.04)" }}>
                      ...
                      <td style={{ padding: "12px 16px", fontSize: 13, fontWeight: 600, color: "#94A3B8" }}>{row.email}</td>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <button
                          ...
                          style={{ padding: "4px 10px", borderRadius: 8, border: "1px solid rgba(0,0,0,0.08)", background: "transparent", color: "#64748B", fontSize: 10, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}
                        >
        ...
        {activeTab === "waitlist" && (
          <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(0,0,0,0.07)" }}>
              ...
              {waitlistQ.data && waitlistQ.data.length > 0 && (
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <button
                    ...
                    style={{ padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#34D399", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}
                  >
                    {copiedEmail === "__all__" ? "✓ Copied!" : "📋 Copy All Emails"}
                  </button>
                  <button
            ...
            {waitlistQ.data && waitlistQ.data.length === 0 && (
              <div style={{ padding: 40, textAlign: "center", color: "#64748B", fontSize: 13 }}>No waitlist signups yet.</div>
            )}
            {waitlistQ.data && waitlistQ.data.length > 0 && (
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
        ...
        {activeTab === "scores" && (
          <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(0,0,0,0.07)" }}>
            ...
            {scoresQ.data && scoresQ.data.length === 0 && (
              <div style={{ padding: 40, textAlign: "center", color: "#64748B", fontSize: 13 }}>No exam results yet.</div>
            )}
            {scoresQ.data && scoresQ.data.length > 0 && (
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ background: "#FFFFFF", borderRadius: 16, border: "1px solid rgba(0,0,0,0.07)", overflow: "hidden" }}>
              <div style={{ padding: "16px 20px", borderBottom: "1px solid rgba(0,0,0,0.07)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <button className="admin-btn" onClick={() => healthQ.refetch()} style={{ padding: "6px 14px", borderRadius: 20, border: "1px solid rgba(0,0,0,0.09)", background: "transparent", color: "#64748B", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>↻ Refresh</button>
              </div>
            ...
            {healthQ.data && (
              <div style={{ background: "#FFFFFF", borderRadius: 16, border: "1px solid rgba(0,0,0,0.07)", overflow: "hidden" }}>
                ...
                {healthQ.data.recentPurchases.length === 0 && (
                  <div style={{ padding: 32, textAlign: "center", color: "#64748B", fontSize: 13 }}>No purchases in the last 24 hours.</div>
                )}
                {healthQ.data.recentPurchases.length > 0 && (
                  <div style={{ overflowX: "auto" }}>
                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
        ...
        {activeTab === "errors" && (
          <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(0,0,0,0.07)" }}>
            ...
            {errorsQ.data && errorsQ.data.length === 0 && (
              <div style={{ padding: 40, textAlign: "center", color: "#64748B", fontSize: 13 }}>No error reports. 🎉</div>
            )}
            {errorsQ.data && errorsQ.data.length > 0 && (
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, flexWrap: "wrap" }}>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ display: "flex", gap: 8, marginBottom: 8, flexWrap: "wrap", alignItems: "center" }}>
                            ...
                            <span style={{ fontSize: 10, color: "#64748B" }}>{formatDate(row.createdAt)}</span>
                          </div>
                          <div style={{ fontSize: 13, color: "#94A3B8", lineHeight: 1.5, marginBottom: row.details ? 6 : 0 }}>
                            {row.questionText}
                          </div>
                          {row.details && (
        ...
        {activeTab === "feedback" && (
          <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(0,0,0,0.07)" }}>
            ...
            {feedbackQ.data && feedbackQ.data.length === 0 && (
              <div style={{ padding: 40, textAlign: "center", color: "#64748B", fontSize: 13 }}>No feedback yet.</div>
            )}
            {feedbackQ.data && feedbackQ.data.length > 0 && (
              <div style={{ display: "flex", flexDirection: "column" }}>
                {feedbackQ.data.map((row) => {
                  const examStyle = EXAM_TYPE_COLORS[row.examType] ?? { bg: "#F8FAFC", color: "#64748B" };
