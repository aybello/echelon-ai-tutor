...
// Adapt WpiClass1WaterQuestion to the shape expected by sub-components
type QCompat = WpiClass1WaterQuestion & { q: string; wrongExp?: Record<number, string> };
...
export default function WpiClass1WaterQuiz() {
  usePageMeta({
    ...
    description:
      "Practice for the WPI Class I Water Treatment operator exam (BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan, Manitoba) with 502 questions across 5 modules. AI Tutor, step-by-step solutions, and confidence tracking included.",
    path: "/wpi-class1-water",
    keywords:
      "WPI Class I water treatment exam prep, BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan water operator, Manitoba water operator, WPI practice questions",
  });
  ...
  const moduleStats = useMemo(() => {
    ...
    for (const m of WPI_CLASS1_WATER_MODULES) stats[m] = { correct: 0, total: 0 };
  ...
  return (
    ...
    >
      <SiteNav currentPath="/wpi-class1-water" />
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button
              onClick={() => {
                ...
                const newPool = wpiClass1WaterQuestions.filter((q) => !newCalcOnly || q.isCalc);
            ...
            {WPI_CLASS1_WATER_MODULES.map((m) => {
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <button
                onClick={() => {
                  setHistory([]);
                  setCurrent(toCompat(shuffle([...wpiClass1WaterQuestions])[0]));
                  setSelected(null);
                  setConfidence(null);
                  setConfirmed(false);
                  setShowSteps(false);
