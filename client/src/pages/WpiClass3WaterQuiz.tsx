// WPI CLASS III WATER TREATMENT PRACTICE QUIZ
...
// Adapt WpiClass3WaterQuestion to the shape expected by sub-components
type QCompat = WpiClass3WaterQuestion & { q: string; wrongExp?: Record<number, string> };
...
const MODULE_COLORS: Record<string, { bg: string; color: string }> = {
  ...
  "Process Control & Optimization":    { bg: "#DCFCE7", color: "#059669" },
  "Distribution System Management":    { bg: "#CCFBF1", color: "#0891B2" },
  "Regulatory Compliance & QMS":       { bg: "#FEE2E2", color: "#DC2626" },
};
...
export default function WpiClass3WaterQuiz() {
  usePageMeta({
    ...
    description:
      "Practice for the WPI Class III Water Treatment operator exam (BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan, Manitoba) with 502 questions across 5 modules. AI Tutor, step-by-step solutions, and confidence tracking included.",
    path: "/wpi-class3-water",
    keywords:
      "WPI Class III water treatment exam prep, BC EOCP Level III, Alberta AWWOA Class III, Saskatchewan water operator, Manitoba water operator, WPI practice questions",
  });
  ...
  const moduleStats = useMemo(() => {
    ...
    for (const m of WPI_CLASS3_WATER_MODULES) stats[m] = { correct: 0, total: 0 };
  ...
  return (
    ...
    >
      <SiteNav currentPath="/wpi-class3-water" />
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "32px 16px 80px" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13, color: "#64748B", margin: 0, lineHeight: 1.5 }}>
            502 questions · BC (EOCP Level I) · Alberta (AWWOA Class I) · SK · MB ·{" "}
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button
              onClick={() => {
                ...
                const newPool = wpiClass3WaterQuestions.filter((q) => !newCalcOnly || q.isCalc);
            ...
            {WPI_CLASS3_WATER_MODULES.map((m) => {
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <button
                onClick={() => {
                  setHistory([]);
                  setCurrent(toCompat(shuffle([...wpiClass3WaterQuestions])[0]));
                  setSelected(null);
                  setConfidence(null);
                  setConfirmed(false);
                  setShowSteps(false);
