...
export default function WpiClass3WaterCollQuiz() {
  ...
  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, isLoading: bankLoading, dbUnavailable } = useQuestionBank("wpi-class3-wastewater-coll", "lazy");
