...
export default function Class1WastewaterCollMockExam() {
  usePageMeta({
  ...
  return (
    <MockExamShell
      title="Ontario Class 1 Wastewater Collection Mock Exam"
      badge="ONTARIO CLASS 1 · WASTEWATER COLLECTION"
      metaDescription="100-question timed mock exam for Ontario Class 1 Wastewater Collection certification. 2-hour timer, 70% pass threshold."
      metaKeywords="Ontario Class 1 Wastewater Collection mock exam, Ontario operator certification"
      examQuestions={100}
      ...
      price={99}
      backPath="/class1-wastewater"
      practicePath="/class1-wastewater-coll"
      practiceLabel="Class 1 Wastewater Collection Practice"
      showProvinceSelector={false}
      currentPath="/class1-wastewater-coll-mock"
      infoLine={`${POOL.length} questions · Ontario Class 1 Wastewater Collection`}
      stream="wastewater"
      accentColor="#065F46"
    />
  );
