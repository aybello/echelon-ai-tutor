...
export default function Class1WaterDistQuiz() {
  usePageMeta({
    ...
    description: "Practice questions for the Ontario Class 1 Water Distribution operator certification exam. 300 questions aligned to Ontario O. Reg. 170/03 and O. Reg. 129/04.",
  });
  ...
  const session = useQuizSession({ examType: "class1-water-dist", allQuestions });
  ...
  return (
    <QuizShell
      ...
      courseSubtitle="300 questions · Ontario Class 1 Water Treatment (Distribution)"
      headerGradient="linear-gradient(135deg, #0369A1 0%, #0E7490 100%)"
      headerIcon="🚰"
      headerActions={[
        { label: "📝 Mock Exam →", href: "/class1-water-dist-mock" },
        { label: "🃏 Flashcards", href: "/class1-water-dist-flashcards" },
      ]}
      ...
      mockExamHref="/class1-water-dist-mock"
      ...
      gate={session.trialDone && !session.trialUnlocked ? (
        <QuizGate
          ...
          priceLabel="CA$99"
          paidFeatures={[
            "300 Ontario Class 1 Water Distribution questions — unlimited attempts",
