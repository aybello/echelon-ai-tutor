// WPI CLASS II WASTEWATER TREATMENT PRACTICE QUIZ
...
// Adapt WpiClass2WastewaterQuestion to the shape expected by sub-components
type QCompat = WpiClass2WastewaterQuestion & { q: string; wrongExp?: Record<number, string> };
...
export default function WpiClass2WastewaterQuiz() {
  usePageMeta({
    title: "WPI Class II Wastewater Treatment Practice Quiz — 502 Questions",
    description:
      "Practice for the WPI Class II Wastewater Treatment operator exam (BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan, Manitoba) with 502 questions across 5 modules. AI Tutor, step-by-step solutions, and confidence tracking included.",
    path: "/wpi-class2-wastewater",
    keywords:
      "WPI Class I wastewater treatment exam prep, BC EOCP Level I, Alberta AWWOA Class I, Saskatchewan water operator, Manitoba water operator, WPI practice questions",
  });
  ...
  const moduleStats = useMemo(() => {
    ...
    for (const m of WPI_CLASS2_WASTEWATER_MODULES) stats[m] = { correct: 0, total: 0 };
  ...
  return (
    ...
    >
      <SiteNav currentPath="/wpi-class2-wastewater" />
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button
              onClick={() => {
                ...
                const newPool = wpiClass2WastewaterQuestions.filter((q) => !newCalcOnly || q.isCalc);
            ...
            {WPI_CLASS2_WASTEWATER_MODULES.map((m) => {
        ...
        {allDone ? (
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/wpi-class2-wastewater-mock">
                <button
                  style={{
                    padding: "12px 28px",
                    borderRadius: 10,
