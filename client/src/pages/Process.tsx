            ...
            <div style={{
              ...
              <div style={{ marginBottom: 18 }}>
                ...
                <div style={{ fontSize: 11, color: "#64748B" }}>
                  All 7 treatment stages in sequence — tap any step to open it in the Step Explorer
                </div>
              </div>
              <ProcessMap
              ...
              <div style={{ marginTop: 24, borderTop: "1px solid #F1F5F9", paddingTop: 20 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 0, overflowX: "auto" }}>
                  {[
                    { label: "Raw", value: "5–500 NTU", color: "#B45309", bg: "#FEF3C7" },
                    { label: "Post-Coag", value: "Still high", color: "#7C3AED", bg: "#EDE9FE" },
                    { label: "Post-Floc", value: "Floc visible", color: "#BE185D", bg: "#FCE7F3" },
                    { label: "Post-Sed", value: "1–10 NTU", color: "#B45309", bg: "#FEF9C3" },
                    { label: "Post-Filter", value: "<0.3 NTU", color: "#0F766E", bg: "#CCFBF1" },
                    { label: "Post-Disinfect", value: "<0.3 NTU", color: "#D97706", bg: "#FEF9C3" },
                    { label: "At Tap", value: "<1 NTU ✓", color: "#059669", bg: "#D1FAE5" },
                  ].map((q, qi, arr) => (
