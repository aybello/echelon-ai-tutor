...
export default function WpiClass3WastewaterQuiz() {
  usePageMeta({
    title: "WPI Class 3 Wastewater Treatment Practice Questions",
    description: "Practice Questions for WPI Class 3 Wastewater Treatment operator certification exam. Practice with hundreds of questions aligned to Canadian provincial standards.",
    noindex: true
  });

  const { questions: dbQuestions, modules: dbModules, overviews: dbOverviews, formulaLinks, isLoading: bankLoading, dbUnavailable } = useQuestionBank("wpi-class3-wastewater", "lazy");
