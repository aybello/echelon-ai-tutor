...
import { createLazyClarifierThreeLab } from "@/components/LazyClarifierThreeLab";

// Keep this lazy wrapper route-local. React caches a rejected lazy import, so
// sharing one instance with the Process Guide would poison this page after a
// transient guide-only chunk failure.
const ClarifierThreeLab = createLazyClarifierThreeLab("equipment");
